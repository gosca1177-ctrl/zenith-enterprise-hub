...
import { Workflow, User, Mail, Lock, ShieldCheck } from "lucide-react";
            ...
            <Card className="bg-card border-white/5 rounded-2xl overflow-hidden shadow-2xl">
              ...
              <form onSubmit={handleLogin}>
                <CardContent className="space-y-5 pt-4">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="password" title="password" className="text-[10px] uppercase tracking-widest opacity-60">Security Key</Label>
                    <div className="relative">
            ...
            <Card className="bg-card border-white/5 rounded-2xl overflow-hidden shadow-2xl">
              ...
              <form onSubmit={handleSignUp}>
                <CardContent className="space-y-5 pt-4">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="signup-password" title="password" className="text-[10px] uppercase tracking-widest opacity-60">Create Security Key</Label>
                    <div className="relative">
                      <Lock className="absolute left-3 top-1/2 -translate-y-1/2 size-4 text-primary/40" />
                      <Input 
                        id="signup-password" 
